		...
		wp_localize_script(
			...
			array(
				...
				'strings'           => array(
					...
					'warnNoConsent'  => __( 'нет согласия на ПДн', 'art-forms' ),
					...
					'privacyUrl'     => __( 'Ссылка на политику', 'art-forms' ),
					...
					'typeConsent'    => __( 'Согласие на ПДн', 'art-forms' ),
					...
					'hintConsent'    => __( 'Обязательная галочка согласия. Можно добавить ссылку на политику.', 'art-forms' ),
